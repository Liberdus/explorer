...
export const DailyTxFeeSetChart: React.FC = () => {
  ...
  // Tooltip formatter for transaction fee set
  const tooltipFormatter = (
    ...
    return `<div style="font-family: Inter, sans-serif; font-size: 13px;">
      ...
      <div>
        <span style="color: #666;">Transaction Fee Set:</span> <span style="font-weight: 600; color: #000;">$${txFeeSet}</span>
      </div>
    </div>`
  }

  return (
    <div className={styles.DailyTxFeeSetChart}>
      <ContentLayout
        title="Daily Transaction Fee Set (USD) Chart"
        ...
        <div className={styles.chartContainer}>
          <div className={styles.chartWrapper}>
            {loading ? (
              ...
              <DailyStatsChart
                title="Daily Transaction Fee Set (USD) Chart"
                subTitle="Historical daily transaction fee set in USD"
                height={height}
                data={seriesData}
                yAxisTitle="Transaction Fee Set (USD)"
          ...
          <div className={styles.infoPanel}>
            ...
            <div className={styles.infoPanelContent}>
              <p>
                The Daily Transaction Fee Set (USD) chart shows the historical transaction fee set in USD.
              </p>
              {highest && (
                <div className={styles.highlight}>
                  ...
                  <div className={styles.highlightContent}>
                    ...
                    <div className={styles.highlightText}>
                      Highest transaction fee set of <strong>${highest.value}</strong> on{' '}
              ...
              {lowest && lowest.value !== Infinity && (
                <div className={styles.highlight}>
                  ...
                  <div className={styles.highlightContent}>
                    <div className={styles.highlightLabel}>HIGHLIGHT</div>
                    <div className={styles.highlightText}>
                      Lowest transaction fee set of <strong>${lowest.value}</strong> on{' '}
              ...
              {current && current > 0 && (
                <div className={styles.currentPrice}>
                  <div className={styles.currentPriceLabel}>CURRENT TRANSACTION FEE SET</div>
